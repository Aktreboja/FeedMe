import { Business, Alias } from '../../../types/business';
...
const BusinessCard = ({
  ...
  return (
    <div
      className="border w-[95%] md:w-full max-w-[1100px] mx-auto  shadow-md cursor-pointer flex my-3 rounded-r-md h-36  hover:shadow-lg duration-100 "
      ...
      <div className="px-3">
        ...
        <div className="flex flex-col">
          ...
          <p className="mt-0.5 hidden md:block">
            {review_count as number} Reviews
          </p>
        </div>
